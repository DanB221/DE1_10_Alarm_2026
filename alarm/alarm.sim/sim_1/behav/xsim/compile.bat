...
REM
REM Generated by Vivado on Thu Apr 23 14:49:10 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_DEB_vhdl.prj"
call xvhdl  --incr --relax -prj tb_DEB_vhdl.prj -log xvhdl.log
